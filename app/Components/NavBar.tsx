...
const Navbar = () => {
  ...
  return (
    ...
    >
      <nav
        className={`h-20 flex w-full justify-between ${
                    ...
                    >
                      ...
                      {selectedLink === link.label &&
                        link?.MenuItems?.length > 1 && (
                          <div
                            suppressHydrationWarning={true}
                            className="absolute h-full w-full left-[120%] z-10000 top-4 justify-center flex"
                          >
                      ...
                      item.MenuItems?.map((i, index) => (
                        ...
                        >
                          <Link
                            ...
                            className="text-sm hover:text-[#a79436]"
                            href={i.href}
                          >
                            {i.label}
                          </Link>
